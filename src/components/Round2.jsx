...
import ctfimage from "../assets/charizard.jpg"; // Ensure the image path is correct

function CharizardChallenge() {
  ...
  return (
    <div className="relative flex flex-col items-center min-h-screen overflow-hidden text-white bg-gray-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="animate-bounce bg-red-600 opacity-40 rounded-full w-[500px] h-[500px] blur-3xl absolute top-10 left-20"></div>
        <div className="animate-bounce bg-yellow-700 opacity-40 rounded-full w-[600px] h-[600px] blur-3xl absolute bottom-10 right-20"></div>
      </div>
      ...
      <div className="container relative z-10 p-5 mx-auto">
        ...
        Charizard Challenge - Pokémon CTF
        </h1>

        {/* Question Text with Animation */}
        <p className="container mb-6 text-lg text-center text-white animate-pulse">
          Welcome to the Charizard Challenge! Your task is to uncover the hidden flag
...
export default CharizardChallenge;
