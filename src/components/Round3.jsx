...
import ctfimage from "../assets/pikachu.png"; // Ensure the image path is correct

function PikachuChallenge() {
  ...
  const handleFlagSubmit = async (e) => {
    ...
    try {
      if (flag === "POKEMON123") {
        setPoints(points + 60); // Increment points on correct flag

        const documentData = {
          question: "What is the flag for Pikachu Challenge?",
          answer: flag,
          points: points + 30,
        };
  ...
  return (
    <div className="relative flex flex-col items-center min-h-screen overflow-hidden text-white bg-gray-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="animate-bounce bg-yellow-400 opacity-40 rounded-full w-[500px] h-[500px] blur-3xl absolute top-10 left-20"></div>
        <div className="animate-bounce bg-orange-500 opacity-40 rounded-full w-[600px] h-[600px] blur-3xl absolute bottom-10 right-20"></div>
      </div>
      ...
      <div className="container relative z-10 p-5 mx-auto">
        ...
        Pikachu Challenge - Pokémon CTF
        </h1>

        {/* Question Text with Animation */}
        <p className="container mb-6 text-lg text-center text-white animate-pulse">
          Welcome to the Pikachu Challenge! Your task is to uncover the hidden flag
          ...
          flag, enter it below to score <strong>60 points</strong>. Good luck,
          Trainer!
        </p>
...
export default PikachuChallenge;
